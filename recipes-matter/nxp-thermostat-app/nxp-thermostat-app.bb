PN = "nxp-thermostat-app"
SUMMARY = "Matter NXP Thermostat App CLI"
LICENSE = "Apache-2.0"
...
SRC_URI += "file://nxp-thermostat-app.service"
MATTER_PY_PATH ?= "${STAGING_BINDIR_NATIVE}/python3-native/python3"

inherit systemd

SYSTEMD_SERVICE:${PN} = "nxp-thermostat-app.service"
SYSTEMD_AUTO_ENABLE:${PN} = "disable"

APP_PATH = "examples/nxp-thermostat/linux"
APP_BINARY = "nxp-thermostat-app"
...
do_install() {
    ...
    install -m 644 ${WORKDIR}/nxp-thermostat-app.service ${D}/lib/systemd/system/
}
