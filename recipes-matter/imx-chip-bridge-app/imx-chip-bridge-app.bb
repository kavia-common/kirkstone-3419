PN = "imx-chip-bridge-app"
SUMMARY = "Matter IMX Chip Bridge App CLI"
LICENSE = "Apache-2.0"
...
SRC_URI += "file://imx-chip-bridge-app.service"
MATTER_PY_PATH ?= "${STAGING_BINDIR_NATIVE}/python3-native/python3"

inherit systemd

SYSTEMD_SERVICE:${PN} = "imx-chip-bridge-app.service"
SYSTEMD_AUTO_ENABLE:${PN} = "disable"

APP_PATH = "examples/bridge-app/nxp/linux-imx"
APP_BINARY = "imx-chip-bridge-app"
...
do_install() {
    ...
    install -m 644 ${WORKDIR}/imx-chip-bridge-app.service ${D}/lib/systemd/system/
}
